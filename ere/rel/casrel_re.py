...
epochs = 100
learning_rate = 1e-5
base_path = '/Users/soutsukyou/Desktop/KG/ere/'  # 本机我使用的绝对路径
...
train_path = base_path + 'data/A61L/train.json'
test_path = base_path + 'data/A61L/test.json'
dev_path = base_path + 'data/A61L/dev.json'
schemas_path = base_path + 'data/A61L/schemas.json'
model_save_path = base_path + 'checkpoint/rel/casrel_a61l.weights'
...
def evaluate(data):
    ...
    f = open('dev_pred_casrel.json', 'w', encoding='utf-8')
    pbar = tqdm()
    for d in data:
        R = set([SPO(spo) for spo in extract_spoes(d['text'])])
